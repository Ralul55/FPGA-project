...
architecture tb of piso_actual_tb is
    ...
    signal boton_i_tb       : std_logic_vector(4 downto 1) := (others => '0');
    signal boton_e_tb       : std_logic_vector(4 downto 1) := (others => '0');
...
--------------------------------------------------------------------    
        ...
        boton_e_tb <= "0010"; -- destino 2, EXTERIOR
        boton_i_tb <= "0001"; -- destino 1, INTERIOR
        wait_rising(5);
        estado_actual_tb <= "000100";
        wait_rising(2);
        boton_e_tb <= (others => '0');       
